...
// node_modules/keen-slider/vue.js
var require_vue2 = __commonJS({
  "node_modules/keen-slider/vue.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var n = require_vue();
    var t = function() {
    ...
    function u(n2, t2) {
      return t2 = t2 || document, "function" == typeof n2 && (n2 = n2(t2)), Array.isArray(n2) ? n2 : "string" == typeof n2 ? e(t2.querySelectorAll(n2)) : n2 instanceof HTMLElement ? [n2] : n2 instanceof NodeList ? e(n2) : [];
    }
    function s(n2) {
    ...
    function p(n2) {
      ...
      return { height: r(t2.height, n2.offsetHeight), width: r(t2.width, n2.offsetWidth) };
    }
    function v(n2, t2, i2, e2) {
      var r2 = n2 && n2[t2];
    ...
    function g(n2) {
      var t2, e2, r2, o2, u2, s2, c2, d2, p2, m2, g2, b2, x2, k2, y2 = 1 / 0, w2 = [], M = null, T = 0;
      function C(n3) {
        _(T + n3);
      }
      function E(n3) {
      ...
      function z(n3) {
        var t3 = Math.floor(Math.abs(h(n3 / e2))), r3 = h((n3 % e2 + e2) % e2);
        r3 === e2 && (r3 = 0);
        var a2 = f(n3), o3 = c2.indexOf(i([], c2, true).reduce(function(n4, t4) {
          return Math.abs(t4 - r3) < Math.abs(n4 - r3) ? t4 : n4;
        })), u3 = o3;
        return a2 < 0 && t3++, o3 === s2 && (u3 = 0, t3 += a2 > 0 ? 1 : -1), { abs: u3 + t3 * s2 * a2, origin: o3, rel: u3 };
      }
      function I(n3, t3, i2) {
        var e3;
        if (t3 || !S()) return A(n3, i2);
        if (!D(n3)) return null;
        var r3 = z(null != i2 ? i2 : T), a2 = r3.abs, o3 = n3 - r3.rel, u3 = a2 + o3;
        e3 = A(u3);
        var c3 = A(u3 - s2 * f(o3));
        return (null !== c3 && Math.abs(c3) < Math.abs(e3) || null === e3) && (e3 = c3), h(e3);
      }
      function A(n3, t3) {
        if (null == t3 && (t3 = h(T)), !D(n3) || null === n3) return null;
        n3 = Math.round(n3);
        var i2 = z(t3), r3 = i2.abs, a2 = i2.rel, o3 = i2.origin, u3 = O(n3), d3 = (t3 % e2 + e2) % e2, l2 = c2[o3], f2 = Math.floor((n3 - (r3 - a2)) / s2) * e2;
        return h(l2 - d3 - l2 + c2[u3] + f2 + (o3 === s2 ? e2 : 0));
      }
      function D(n3) {
        return L(n3) === n3;
      }
      ...
      function _(t3) {
        var i2;
        i2 = t3 - T, w2.push({ distance: i2, timestamp: a() }), w2.length > 6 && (w2 = w2.slice(-6)), T = h(t3);
        var e3 = P().abs;
        if (e3 !== M) {
          var r3 = null !== M;
          M = e3, r3 && n2.emit("slideChanged");
        }
      }
      function P(i2) {
        var a2 = i2 ? null : function() {
          if (s2) {
            var n3 = S(), t3 = n3 ? (T % e2 + e2) % e2 : T, i3 = (n3 ? T % e2 : T) - u2[0][2], a3 = 0 - (i3 < 0 && n3 ? e2 - Math.abs(i3) : i3), c3 = 0, d3 = z(T), l2 = d3.abs, v2 = d3.rel, h2 = u2[v2][2], y3 = u2.map(function(t4, i4) {
              var r3 = a3 + c3;
              (r3 < 0 - t4[0] || r3 > 1) && (r3 += (Math.abs(r3) > e2 - 1 && n3 ? e2 : 0) * f(-r3));
              var u3 = i4 - v2, d4 = f(u3), p3 = u3 + l2;
              n3 && (-1 === d4 && r3 > h2 && (p3 += s2), 1 === d4 && r3 < h2 && (p3 -= s2), null !== g2 && p3 < g2 && (r3 += e2), null !== b2 && p3 > b2 && (r3 -= e2));
              var m3 = r3 + t4[0] + t4[1], x3 = Math.max(r3 >= 0 && m3 <= 1 ? 1 : m3 < 0 || r3 > 1 ? 0 : r3 < 0 ? Math.min(1, (t4[0] + r3) / t4[0]) : (1 - r3) / t4[0], 0);
              return c3 += t4[0] + t4[1], { abs: p3, distance: o2.rtl ? -1 * r3 + 1 - t4[0] : r3, portion: x3, size: t4[0] };
            });
            return l2 = L(l2), v2 = O(l2), { abs: L(l2), length: r2, max: k2, maxIdx: m2, min: x2, minIdx: p2, position: T, progress: n3 ? t3 / e2 : T / r2, rel: v2, slides: y3, slidesLength: e2 };
          }
        }();
        return t2.details = a2, n2.emit("detailsChanged"), a2;
      }
      return t2 = { absToRel: O, add: C, details: null, distToIdx: E, idxToDist: I, init: function(t3) {
        if (function() {
          if (o2 = n2.options, u2 = (o2.trackConfig || []).map(function(n3) {
            return [v(n3, "size", 1), v(n3, "spacing", 0), v(n3, "origin", 0)];
          }), s2 = u2.length) {
            e2 = h(u2.reduce(function(n3, t5) {
              return n3 + t5[0] + t5[1];
            }, 0));
            var t4, i3 = s2 - 1;
            r2 = h(e2 + u2[0][2] - u2[i3][0] - u2[i3][2] - u2[i3][1]), c2 = u2.reduce(function(n3, i4) {
              if (!n3) return [0];
              var e3 = u2[n3.length - 1], r3 = n3[n3.length - 1] + (e3[0] + e3[2]) + e3[1];
              return r3 -= i4[2], n3[n3.length - 1] > r3 && (r3 = n3[n3.length - 1]), r3 = h(r3), n3.push(r3), (!t4 || t4 < r3) && (d2 = n3.length - 1), t4 = r3, n3;
            }, null), 0 === r2 && (d2 = 0), c2.push(h(e2));
          }
        }(), !s2) return P(true);
        var i2;
        !function() {
          var t4 = n2.options.range, i3 = n2.options.loop;
          g2 = p2 = i3 ? v(i3, "min", -1 / 0) : 0, b2 = m2 = i3 ? v(i3, "max", y2) : d2;
          var e3 = v(t4, "min", null), r3 = v(t4, "max", null);
          null !== e3 && (p2 = e3), null !== r3 && (m2 = r3), x2 = p2 === -1 / 0 ? p2 : n2.track.idxToDist(p2 || 0, true, 0), k2 = m2 === y2 ? m2 : I(m2, true, 0), null === r3 && (b2 = m2), v(t4, "align", false) && m2 !== y2 && 0 === u2[O(m2)][2] && (k2 -= 1 - u2[O(m2)][0], m2 = E(k2 - T)), x2 = h(x2), k2 = h(k2);
        }(), i2 = t3, Number(i2) === i2 ? C(A(L(t3))) : P();
      }, to: _, velocity: function() {
        var n3 = a(), t3 = w2.reduce(function(t4, i2) {
          var e3 = i2.distance, r3 = i2.timestamp;
          return n3 - r3 > 200 || (f(e3) !== f(t4.distance) && t4.distance && (t4 = { distance: 0, lastTimestamp: 0, time: 0 }), t4.time && (t4.distance += e3), t4.lastTimestamp && (t4.time += r3 - t4.lastTimestamp), t4.lastTimestamp = r3), t4;
    ...
    function b(n2) {
      ...
      function h2() {
        ...
        if (e3 || !t3) {
          var l2 = m2(e3), h3 = l2.dist, g3 = l2.dur;
      ...
      n2.on("updated", g2), n2.on("optionsChanged", g2), n2.on("created", g2), n2.on("dragStarted", function() {
        ...
        "snap" === e3 && function() {
          var e4 = n2.track, r3 = n2.track.details, u3 = r3.position, s3 = f(v2());
          (u3 > o2 || u3 < a2) && (s3 = 0);
          var c3 = t2 + s3;
          0 === r3.slides[e4.absToRel(c3)].portion && (c3 -= s3), t2 !== i2 && (c3 = i2), f(e4.idxToDist(c3, true)) !== s3 && (c3 += s3), c3 = d2(c3);
          var l2 = e4.idxToDist(c3, true);
          n2.animator.start([{ distance: l2, duration: 500, easing: function(n3) {
            return 1 + --n3 * n3 * n3 * n3 * n3;
          } }]);
    ...
    function x(n2) {
      var t2, i2, e2, r2, a2, o2, p2, v2, h2, m2, g2, b2, x2, k2, y2, w2, M, T, C = d();
      function E(t3) {
        if (o2 && v2 === t3.id) {
          var u2 = D(t3);
          if (h2) {
            if (!A(t3)) return I(t3);
            m2 = u2, h2 = false, n2.emit("dragChecked");
          }
          if (w2) return m2 = u2;
          s(t3);
          var d2 = function(t4) {
            if (M === -1 / 0 && T === 1 / 0) return t4;
            var e3 = n2.track.details, o3 = e3.length, u3 = e3.position, s2 = l(t4, M - u3, T - u3);
            if (0 === o3) return 0;
            if (!n2.options.rubberband) return s2;
            if (u3 <= T && u3 >= M) return t4;
            if (u3 < M && i2 > 0 || u3 > T && i2 < 0) return t4;
            var c2 = (u3 < M ? u3 - M : u3 - T) / o3, d3 = r2 * o3, f2 = Math.abs(c2 * d3), p3 = Math.max(0, 1 - f2 / a2 * 2);
            return p3 * p3 * t4;
          }(p2(m2 - u2) / r2 * e2);
          i2 = f(d2);
          var x3 = n2.track.details.position;
          (x3 > M && x3 < T || x3 === M && i2 > 0 || x3 === T && i2 < 0) && c(t3), g2 += d2, !b2 && Math.abs(g2 * r2) > 5 && (b2 = true), n2.track.add(d2), m2 = u2, n2.emit("dragged");
        }
      }
      function z(t3) {
        !o2 && n2.track.details && n2.track.details.length && (g2 = 0, o2 = true, b2 = false, h2 = true, v2 = t3.id, A(t3), m2 = D(t3), n2.emit("dragStarted"));
      }
      function I(t3) {
        o2 && v2 === t3.idChanged && (o2 = false, n2.emit("dragEnded"));
      }
      function A(n3) {
      ...
      function _() {
        if (C.purge(), n2.options.drag && !n2.options.disabled) {
          ...
          i3 = n2.options.dragSpeed || 1, p2 = "function" == typeof i3 ? i3 : function(n3) {
            ...
            u("[".concat(n3, "]:not([").concat(n3, "=false])"), t2).map(function(n4) {
              C.add(n4, "dragstart", c), C.add(n4, "mousedown", c), C.add(n4, "touchstart", c);
            });
          ...
          u("[".concat(r3, "]:not([").concat(r3, "=false])"), n2.container).map(function(n3) {
            return function(n4) {
              var t3;
              C.input(n4, "touchstart", function(n5) {
                t3 = D(n5), w2 = true, y2 = true;
              }, { passive: true }), C.input(n4, "touchmove", function(i4) {
                var e3 = L(), r4 = e3 ? n4.scrollHeight - n4.clientHeight : n4.scrollWidth - n4.clientWidth, a3 = t3 - D(i4), o3 = e3 ? n4.scrollTop : n4.scrollLeft, u2 = e3 && "scroll" === n4.style.overflowY || !e3 && "scroll" === n4.style.overflowX;
                if (t3 = D(i4), (a3 < 0 && o3 > 0 || a3 > 0 && o3 < r4) && y2 && u2) return w2 = true;
                y2 = false, s(i4), w2 = false;
    ...
    function k(n2) {
      ...
      function f2() {
        d2(), i2 = n2.options.vertical, n2.options.disabled || "custom" === n2.options.renderMode || (e2 = "auto" === v(n2.options.slides, "perView", null), n2.on("detailsChanged", a2), (t2 = n2.slides).length && l2());
      }
    ...
    function y(n2, i2) {
      return function(e2) {
        var r2, a2, s2, c2, l2, f2, h2 = d();
        function m2(n3) {
          var t2;
          o(e2.container, "reverse", "rtl" !== (t2 = e2.container, window.getComputedStyle(t2, null).getPropertyValue("direction")) || n3 ? null : ""), o(e2.container, "v", e2.options.vertical && !n3 ? "" : null), o(e2.container, "disabled", e2.options.disabled && !n3 ? "" : null);
        }
        function g2() {
          b2() && M();
        }
        function b2() {
          var n3 = null;
          if (c2.forEach(function(t2) {
            t2.matches && (n3 = t2.__media);
          }), n3 === r2) return false;
          r2 || e2.emit("beforeOptionsChanged"), r2 = n3;
          var i3 = n3 ? s2.breakpoints[n3] : s2;
          return e2.options = t(t({}, s2), i3), m2(), I(), A(), C(), true;
        }
        function x2(n3) {
          var t2 = p(n3);
          return (e2.options.vertical ? t2.height : t2.width) / e2.size || 1;
        }
        function k2() {
          return e2.options.trackConfig.length;
        }
        function y2(n3) {
          for (var o2 in r2 = false, s2 = t(t({}, i2), n3), h2.purge(), a2 = e2.size, c2 = [], s2.breakpoints || []) {
            var u2 = window.matchMedia(o2);
            u2.__media = o2, c2.push(u2), h2.add(u2, "change", g2);
          }
          h2.add(window, "orientationchange", z), h2.add(window, "resize", E), b2();
        }
        function w2(n3) {
          e2.animator.stop();
          var t2 = e2.track.details;
          e2.track.init(null != n3 ? n3 : t2 ? t2.abs : 0);
        }
        function M(n3) {
          w2(n3), e2.emit("optionsChanged");
        }
        function T(n3, t2) {
          if (n3) return y2(n3), void M(t2);
          I(), A();
          var i3 = k2();
          C(), k2() !== i3 ? M(t2) : w2(t2), e2.emit("updated");
        }
        function C() {
          var n3 = e2.options.slides;
          if ("function" == typeof n3) return e2.options.trackConfig = n3(e2.size, e2.slides);
          for (var t2 = e2.slides, i3 = t2.length, r3 = "number" == typeof n3 ? n3 : v(n3, "number", i3, true), a3 = [], o2 = v(n3, "perView", 1, true), u2 = v(n3, "spacing", 0, true) / e2.size || 0, s3 = "auto" === o2 ? u2 : u2 / o2, c3 = v(n3, "origin", "auto"), d2 = 0, l3 = 0; l3 < r3; l3++) {
            var f3 = "auto" === o2 ? x2(t2[l3]) : 1 / o2 - u2 + s3, p2 = "center" === c3 ? 0.5 - f3 / 2 : "auto" === c3 ? 0 : c3;
            a3.push({ origin: p2, size: f3, spacing: u2 }), d2 += f3;
          }
          if (d2 += u2 * (r3 - 1), "auto" === c3 && !e2.options.loop && 1 !== o2) {
            var h3 = 0;
            a3.map(function(n4) {
              var t3 = d2 - h3;
              return h3 += n4.size + u2, t3 >= 1 || (n4.origin = 1 - t3 - (d2 > 1 ? 0 : 1 - d2)), n4;
            });
          }
          e2.options.trackConfig = a3;
        }
        function E() {
          I();
          var n3 = e2.size;
          e2.options.disabled || n3 === a2 || (a2 = n3, T());
        }
        function z() {
          E(), setTimeout(E, 500), setTimeout(E, 2e3);
        }
        function I() {
          var n3 = p(e2.container);
          e2.size = (e2.options.vertical ? n3.height : n3.width) || 1;
        }
        function A() {
          e2.slides = u(e2.options.selector, e2.container);
        }
        e2.container = (f2 = u(n2, l2 || document)).length ? f2[0] : null, e2.destroy = function() {
    ...
    var w = function(n2, t2, e2) {
      try {
        return function(n3, t3) {
          var i2, e3 = {};
          return i2 = { emit: function(n4) {
            e3[n4] && e3[n4].forEach(function(n5) {
              n5(i2);
            });
            var t4 = i2.options && i2.options[n4];
            t4 && t4(i2);
          }, moveToIdx: function(n4, t4, e4) {
            var r2 = i2.track.idxToDist(n4, t4);
            if (r2) {
              var a2 = i2.options.defaultAnimation;
              i2.animator.start([{ distance: r2, duration: v(e4 || a2, "duration", 500), easing: v(e4 || a2, "easing", function(n5) {
                return 1 + --n5 * n5 * n5 * n5 * n5;
              }) }]);
            }
          }, on: function(n4, t4, i3) {
            void 0 === i3 && (i3 = false), e3[n4] || (e3[n4] = []);
            var r2 = e3[n4].indexOf(t4);
            r2 > -1 ? i3 && delete e3[n4][r2] : i3 || e3[n4].push(t4);
          }, options: n3 }, function() {
            if (i2.track = g(i2), i2.animator = m(i2), t3) for (var n4 = 0, e4 = t3; n4 < e4.length; n4++) (0, e4[n4])(i2);
            i2.track.init(i2.options.initial || 0), i2.emit("created");
          }(), i2;
        }(t2, i([y(n2, { drag: true, mode: "snap", renderMode: "precision", rubberband: true, selector: ".keen-slider__slide" }), k, x, b], e2 || [], true));
      } catch (n3) {
        console.error(n3);
      }
    };
    exports.useKeenSlider = function(t2, i2) {
      var e2 = n.ref(), r2 = n.ref();
      return n.isRef(t2) && n.watch(t2, function(n2, t3) {
        r2.value && r2.value.update(n2);
      }), n.onMounted(function() {
        e2.value && (r2.value = new w(e2.value, n.isRef(t2) ? t2.value : t2, i2));
      }), n.onUnmounted(function() {
        r2.value && r2.value.destroy();
      }), [e2, r2];
    };
  }
});
export default require_vue2();
...
vue/dist/vue.cjs.js:
  ...
  **)
*/
//# sourceMappingURL=keen-slider_vue.js.map
